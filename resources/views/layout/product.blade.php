                        ...
                        <div class="product_slick slick_slider_activation"
                                ...
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="{{ 'img/product/product1.jpg' }}"
                                                alt="consectetur">
                                        </a>
                            ...
                            <article class="col single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="{{ 'img/product/product2.jpg' }}"
                                                alt="consectetur">
                                        </a>
                                        <div class="product_action">
                                            <ul>
                            ...
                            <article class="col single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="{{ 'img/product/product3.jpg' }}"
                                                alt="consectetur">
                                        </a>
                                        <div class="product_action">
                                            <ul>
                            ...
                            <article class="col single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="{{ 'img/product/product4.jpg' }}"
                                                alt="consectetur">
                                        </a>
                                        <div class="product_action">
                                            <ul>
                            ...
                            <article class="col single_product">
                                <figure>
                                    ...
                                    <figcaption class="product_content text-center">
                                        ...
                                        <h4 class="product_name"><a href="product-details.html">Basic Joggin
                                                Shorts</a>
                                        </h4>
                                        <div class="price_box">
                                            <span class="current_price">$26.00</span>
