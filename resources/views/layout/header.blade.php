            ...
            <div class="row">
                <div class="col-12">
                    <div class="header_top_inner d-flex justify-content-between align-items-center">
                        <div class="header_contact_info">
                            <ul class="d-flex">
                                <li class="text-white"> <i class="bi bi-person-lines-fill"></i> <a
                                        href="tel:+05483716566">+054 8371 65 66</a></li>
                                <li class="text-white"> <i class="bi bi-envelope-at"></i> <a
                                        href="#">uthrstore@domain.com</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="header_top_sidebar d-flex align-items-center">
                            ...
                            <div class="language_currency">
                                <ul class="d-flex">
                                    <li class="language"><a href="#"> Eng <i class="bi bi-translate"></i></a>
                                    </li>
                                    <li class="currency"><a href="#"> USd <i class="bi bi-cash"></i></a>
                                        <ul class="dropdown_currency">
                                            <li><a href="#">රු. LKR</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="col-12">
                    <div class="header_container d-flex justify-content-between align-items-center">
                        ...
                        <div class="header_account">
                            <ul class="d-flex">
                                <li class="header_search"><a href="#"><i class="bi bi-search"></i></a>
                                </li>
                                ...
                                <li><a href="#"><i class="bi bi-bag-heart-fill"></i></a> <span
                                        class="item_count">2</span></li>
                                <li class="shopping_cart"><a href="#"><i class="bi bi-cart-check"></i></a>
